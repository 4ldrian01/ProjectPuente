...
if not DEBUG:
    ...
    if db_engine != 'django.db.backends.sqlite3' and not default_db.get('PASSWORD'):
        raise ValueError('DB_PASSWORD is required when DEBUG=False for non-SQLite databases.')
